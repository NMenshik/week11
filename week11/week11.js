...
function makeEight() {
	const parentElementUL = document.getElementById('practicum8'); //Найдите элемент x
	const newElementLI = document.createElement ('li');//Создайте новый пункт списка y
	newElementLI.textContent = 'Новый элемент'; //Добавьте значение в созданный пункт списка y
	parentElementUL.append(newElementLI); //Добавьте в список х новый элемент y
}
...
function makeNine() {
	...
	const newElementOption = document.createElement('option'); //Создайте новый элемент
	newElementOption.textContent = 'Новый вариант'; //Добавьте текст в созданный эелемент
	select.append(newElementOption); //Добавьте новый элемент в выпадающий список
}
...
function makeThirteen() {
	const practicum13 = document.getElementsByTagName('ol')[0];
...
function makeFourteen() {
	...
	paragraphs.forEach(function (paragraphs) {
		paragraphs.textContent = "Огого, что могу!" //Измените их текстовое содержимое у paragraph
	});
}
...
function makeSixteen() {
	const practicum16 = document.getElementById('practicum16'); //Ваш код
	practicum16.classList.add('practicum15');
}
...
function makeSeventeen() {
	const practicum17 = document.getElementById('practicum17'); //Ваш код
...
function makeEighteen() {
	const practicum18 = document.getElementById('practicum18'); //Ваш код
...
function makeNineteen() {
	const practicum19 = document.getElementById('practicum19'); //Ваш код
...
function makeTwentyOne() {
	...
	newP2.textContent = "Добавлено в конец";
    practicum21.append(newP2);
}
...
function makeTwentyTwo() {
	const practicum22 = document.getElementById('practicum22'); //1 шаг: Найдите элемент
	const checkAtr = practicum22.hasAttribute('src');//2 шаг: Создайте переменную, которая проверяет наличие атрибута у найденного элемента
	const resultAtr = document.getElementById('result22'); //3 шаг: Найдите элемент, в который нужно вставить значение
	resultAtr.innerText = `Атрибут "src" присутствует: ${checkAtr}`; //4 шаг: Добавьте в эелемент текстовое значение 2 шага. Например: переменная = 'Атрибут "src" присутствует: ' + название переменной из 2 шага;
}
...
function makeTwentyFive() {
	const practicum25 = document.getElementById('practicum25'); //1 шаг: Найдите элемент
	practicum25.setAttribute('data-info', 'Дополнительная информация'); //2 шаг: Добавьте элементу, найденному в первом шаге, атрибут: ('data-info', 'Дополнительная информация');
	const Atr = practicum25.getAttribute('data-info'); //3 шаг: Запишите значение атрибута в переменную
	const infoOutput = document.getElementById('infoOutput'); //4 шаг: Найдите элемент, в который нужно вставить значение из 3 шага
	infoOutput.textContent = `Добавленный атрибут: ${Atr}`;//5 шаг: Добавьте в элемент 4 шага текстовое значение 3 шага. Например: переменная = 'Добавленный атрибут: ' + название переменной из 3 шага;
}
...
function makeTwentySeven() {
	const practicum27 = document.getElementById('practicum27'); //Найдите переменную
	const result1 = practicum27.classList.contains('highlight');//Создайте переменную и сохраните в неё результат проверки метода contains. Например: const result = p.classList.contains('active');
	const result2 = document.getElementById('result');//Найдите переменную, в которую нужно вывести результат
	result2.textContent = result1;//Запишите результат в переменную
}
...
input29.addEventListener ('input', handleChange());
